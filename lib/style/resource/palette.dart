...
abstract class Palette {
  ...
  static Color primaryDark = const Color(0xFF2697FF);
  static Color primaryDarkBg = const Color(0xFF212332);
  static Color secondaryDarkBg = const Color(0xFF212332);

  static Color primaryLight = const Color(0xFF1E88E5);
  static Color primaryLightBg = const Color(0xFFE0F7FA);
  static Color secondaryLightBg = const Color(0xFFFFFFFF);
